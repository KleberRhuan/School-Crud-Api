...
@Schema(
  name = "CsvNotificationMessage",
  description = "Estrutura de mensagem WebSocket para notificações em tempo real de importação CSV",
  implementation = CsvNotificationMessage.class,
  example = """
    {
