...
@Schema(
  name = "CsvImportRequestDto",
  description = "Estrutura de requisição para importação de arquivo CSV contendo dados de escolas",
  implementation = CsvImportRequestDto.class,
  example = """
    {
